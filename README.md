![docker image](https://github.com/AG-SEK/nomad-oasis-perolab-umr-image-v1/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/AG-SEK/nomad-oasis-perolab-umr-image-v1/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/AG-SEK/nomad-oasis-perolab-umr-image-v1:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/AG-SEK/nomad-oasis-perolab-umr-image-v1/manifests/main": unauthorized`
